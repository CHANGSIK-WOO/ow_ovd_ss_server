...
# att_embeddings = None
embedding_path = 'data/coco/meta/known_text_embeddings.npy'
att_embeddings = 'data/coco/meta/att_embeddings.pth'
pipline = [dict(type='att_select', log_start_epoch=1)]
thr = 0.75
alpha = 0.3 # 0.3
top_k = 10
use_sigmoid=True
distributions = 'data/coco/meta/distributions_init.pth'
